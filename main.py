...
quandl.ApiConfig.api_key = 'ioi9PN2b7b2yFziyESjB'
df = quandl.get("EOD/AAPL")
#api_key="B643EZPAZU9YAH2S"
# tms= TimeSeries(key=api_key,output_format='pandas')
# df1, m1 = tms.get_daily(symbol='TTM',outputsize='full')
# df2, m2 = tms.get_daily(symbol='RS',outputsize='full')
...
print(dataset)
dataset = dataset.iloc[np.r_[:, -501:-1]]
...
dataset_2 = dataset_2.iloc[np.r_[:, -51:-1]]
df = df.iloc[np.r_[:, -801:-1]]
